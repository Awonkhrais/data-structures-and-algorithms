...
a new array of each of those numbers raised to the 3rd power (hint: look up Math.pow()). Use forEach to solve this problem.
...
Write a function named addQuestion that, given an array of strings, uses map to return a new array containing each string followed
...
const forEachTwoToThe = (arr) => {
  let localArray = [];
  arr.forEach(item => {
    localArray.push(Math.pow(2, item));
  });
...
from challenge 4 and your forEachTwoToThe function from challenge 5, but uses map instead of a for loop or forEach.
------------------------------------------------------------------------------------------------ */
