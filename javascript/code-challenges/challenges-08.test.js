...
const sortByChildren = (charArray) => {
  // Solution code here...
  let newArray= charArray.sort((a,b)=> a.children.length-b.children.length);
  return newArray;
...
const isCapitalized = (str) => {
  // Solution code here...
  let newArray = /\b[A-Z]\w*/g;
  return str.match(newArray) || [];
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let newArray = arr.filter(i => /^[A-J]/g.test(i));
  return newArray;
};
